        ...
        <div className="grid min-h-[calc(100vh-82px)] items-center gap-12 py-16 lg:grid-cols-[1.05fr_.95fr] lg:py-20">
          ...
          >
            ...
            <p className="mt-8 max-w-[580px] text-[17px] leading-8 text-[#667085]">
              Expert visa and travel guidance to help you plan, prepare,
          ...
          >
            <div className="visual-card">
              ...
              {/* JOB FINDER + TRAVEL WITH CONFIDENCE */}
              <div className="absolute bottom-8 left-8 right-8 z-10">
                {/* BRAND NAME */}
                <div className="mb-4 text-[13px] font-black uppercase tracking-[0.18em] text-[#020305]">
                  JOB FINDER
                </div>
                <div className="font-['Manrope'] text-5xl font-extrabold leading-[.95] tracking-[-0.06em] text-[#0b1f3a] sm:text-7xl">
                  TRAVEL
                  <br />
                  WITH
                  <br />

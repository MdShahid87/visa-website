            ...
            <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
              ...
              <div>
                ...
                <p className="mt-7 max-w-[700px] leading-8 text-[#667085]">
                  ...
                  purpose, UAE visa requirements can vary by nationality,
                  visa category and current immigration rules.
                </p>
          ...
          <div className="container">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-[24px] bg-white p-7">
                ...
                <p className="mt-3 leading-7 text-[#667085]">
                  Guidance for work-related visa and employment
              ...
              <div className="rounded-[24px] bg-white p-7">
                ...
                <p className="mt-3 leading-7 text-[#667085]">
                  Assistance with UAE visa stamping and related
            ...
            <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
              ...
              <div>
                ...
                <p className="mt-6 max-w-[720px] leading-8 text-[#667085]">
                  UAE visa requirements, documentation and procedures can
                  vary depending on nationality, visa category and current
                  immigration regulations. Always confirm the latest

            ...
            <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
              ...
              <div>
                ...
                <p className="mt-6 max-w-[720px] leading-8 text-[#667085]">
                  Qatar visa requirements, documentation and procedures
                  can vary depending on nationality, visa category and
                  current immigration regulations. Always confirm the

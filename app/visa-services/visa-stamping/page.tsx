...
export default function VisaStampingPage() {
            ...
            <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
              ...
              <div>
                ...
                <p className="mt-7 max-w-[700px] leading-8 text-[#667085]">
                  Visa stamping requirements and procedures depend on the
                  destination and visa category. Contact us to discuss your
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="border-t border-[#dce1e7] pt-6">
                ...
                <p className="mt-3 leading-7 text-[#667085]">
                  Share your visa type, destination and relevant details.
                </p>
              </div>
              ...
              <div className="border-t border-[#dce1e7] pt-6">
                ...
                <p className="mt-3 leading-7 text-[#667085]">
                  Understand the documentation generally required for the
                  stamping process.
                </p>
              </div>
            ...
            <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
              ...
              <div>
                ...
                <p className="mt-6 max-w-[720px] leading-8 text-[#667085]">
                  Visa stamping requirements and procedures can vary
                  depending on the destination, visa category and current
                  immigration rules. Always confirm the latest requirements
                  before proceeding.
                </p>
              </div>
            </div>
        ...
        <section className="bg-[#d4a72c] py-24">
          <div className="container">
            ...
            <p className="mt-6 max-w-[550px] leading-7 text-[#0b1f3a]/70">
              Speak directly with Abdur Rhaman about your visa stamping
              requirement.
            </p>
